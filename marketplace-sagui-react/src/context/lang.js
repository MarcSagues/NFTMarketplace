const engLiterals = {
  home: {
    slogan: "SAGUI : The art of expressing your art",
    sentence1:
  ...
  createCollection: {
    ...
    imgPrincipalDesc:
      "Select the main image from the collection. This image will be used to present your collection on the home page or other promotional areas of Sagui. If no image is selected, the collection logo will be used. The recommended size is 600 x 400.",
    bannerDesc:
    ...
    urlDesc:
      "Customize your URL on Sagui. Can only contain lowercase letters, numbers, and hyphens.",
    descriptionDesc:
  ...
  profile: {
    ...
    offers: "Offers",
    myOffers: "My offers",
    sentence: "Artist verified by Sagui team",
    bids: "Bids",
  ...
  features: {
    ...
    sentence:
      "Vote and help deciding the evolution of the SAGUI marketplace, the community is the one responsable to add new functionallities to get everyone's product.",
  ...
  buyItemModal: {
    ...
    saguiEarns: "Sagui collects 2% commission on each NFT sale",
  },
  buyNowModal: {
  ...
  redirectModal: {
    ...
    saguiNotResponsable: "¡ SAGUI is not responsible for what may happen !",
  ...
  createItem: {
    ...
    externalLinkDesc:
      "Sagui will add a link on the NFT's detail to help the users get more information",
    royalties: "Royalties",
    royaltiesDesc:
...
const espLiterals = {
  home: {
    slogan: "SAGUI : El Arte de expresar tu Arte",
    sentence1:
  ...
  createCollection: {
    ...
    imgPrincipalDesc:
      "Selecciona la imagen de presentación de la colección. Esta imagen se utilizará para presentar su colección en la página de inicio u otras áreas promocionales de Sagui. Si no se selecciona ninguna imagen, se usará el logo de la colección. El tamaño recomendado és 600 x 400.",
    bannerDesc:
    ...
    urlDesc:
      "Personaliza tu URL en Sagui. Solo puede contener letras minúsculas, números y guiones.",
    descriptionDesc:
  ...
  profile: {
    ...
    sentence: "Artista verificado por el equipo de SAGUI",
    bids: "Pujas",
  ...
  features: {
    ...
    sentence:
      "Vota y contribuye a decidir la evolución del marketplace de SAGUI, la comunidad es la desencadenante de los próximos pasos a añadir para conseguir el producto de todos.",
  ...
  buyItemModal: {
    ...
    saguiEarns: "Sagui recoge un 2% de comisiones en cada venta de NFT",
  },
  buyNowModal: {
  ...
  redirectModal: {
    ...
    saguiNotResponsable:
      "¡ SAGUI no se hace responsable de lo que pueda pasar !",
  ...
  createItem: {
    ...
    externalLinkDesc:
      "Sagui incluirá un enlace a este enlace en el detalle del NFT. Así los usuarios podrán tener mas información.",
    royalties: "Royalties",
    royaltiesDesc:
