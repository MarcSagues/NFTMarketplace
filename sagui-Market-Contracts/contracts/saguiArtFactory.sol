...
import "./SaguiArtTradeable.sol";

contract SaguiArtFactory is OwnableUpgradeable, ERC2771ContextUpgradeable {
    ...
    */
    ...
    function createNFTContract(
        ...
        SaguiArtTradeable nft = new SaguiArtTradeable(
            _name,
            _symbol,
            marketplace,
            address(saguiVerification),
            owner(),
            _forwarder
        );
