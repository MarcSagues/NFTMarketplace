...
/**
 * @title SaguiArtTradeable
 * SaguiArtTradeable - ERC721 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract SaguiArtTradeable is ERC721, ERC2771Context {
    uint256 private _currentTokenID = 0;

    address private _owner;

    /// @notice Sagui Address Verfification
    ISaguiVerification public saguiVerification;
    ...
    // Sagui Marketplace contract
    address marketplace;

    // Sagui contracts manager
    ...
    function updateSaguiVerification(address _verification) external {
        saguiVerification = ISaguiVerification(_verification);
    }
