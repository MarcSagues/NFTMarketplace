...
contract SaguiCommunity is OwnableUpgradeable {
    ...
    function createSuggestion(
        ...
        bool isVerifiedAddress = saguiVerification.checkIfVerified(proposer);
        ...
        suggestionInProgress(_suggestionId)
    {
        ...
        bool isVerifiedArtist = saguiVerification.checkIfVerified(msg.sender);
