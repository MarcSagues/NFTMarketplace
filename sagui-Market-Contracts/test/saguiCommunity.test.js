...
const SaguiCommunity = artifacts.require("SaguiCommunity");
...
/* contract("Community", function ([owner, proposer, depositor]) {
  ...
  beforeEach(async function () {
    this.community = await SaguiCommunity.new(proposerfee, {
      from: owner,
    });

    this.verification = await SaguiVerification.new({ from: owner });

    this.community.updateSaguiVerification(this.verification.address, {
      from: owner,
    });
  });
